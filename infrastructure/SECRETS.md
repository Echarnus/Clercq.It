...
**Note**: As of the latest update, the database password is automatically generated by Terraform using a secure random password generator. This ensures the password always meets Scaleway's strict requirements:
- Between 8 and 128 characters
- At least one digit, one uppercase letter, one lowercase letter, and one special character

The generated password is stored in Terraform state and can be retrieved using `terraform output database_password`.
